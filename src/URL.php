...
class URL
{
    ...
    public static function toRoute($route, $scheme = false)
    {
     ...
     //   $route[0] = $route[0];
        ...
        return static::$urlManager->createUrl($route);
    }
    ...
    {
        return static::$urlManager->createAbsoluteUrl(array_merge((array)$route, $params));
    }    
    ...
    /**
     * 
     * @param \Enjoys\Core\URL\Manager $urlManager
     */
    public static function setUrlmanager(\Enjoys\Core\URL\Manager $urlManager) {
        static::$urlManager = $urlManager;
    }
    
    public static function getUrlManager() : \Enjoys\Core\URL\Manager  {
